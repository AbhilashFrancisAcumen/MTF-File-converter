...
const OUTPUT_COLUMNS = [
  ...
  {
    key: "MTF Led Bal (Funded Value)",
    title: "MTF Led Bal (Funded Value)",
  },
  { key: "MTF Funded Amount", title: "MTF Funded Amount" },
  { key: "MTF Cash Collateral", title: "MTF Cash Collateral" },
  {
    key: "MTF Share Collateral Full 100% (BHC)",
    title: "MTF Share Collateral Full 100% (BHC)",
  },
  {
    key: "MTF Share Collateral after hair-cut (AHC)",
    title: "MTF Share Collateral after hair-cut (AHC)",
  },
  {
    key: "MTF Funded Stock Mkt Val(AHC)",
    title: "MTF Funded Stock Mkt Val(AHC)",
  },
  {
    key: "MTF Funded Stock Mkt Val(BHC)",
    title: "MTF Funded Stock Mkt Val(BHC)",
  },
  ...
  {
    key: "DEF (Normal) Led Balance",
    title: "DEF (Normal) Led Balance",
  },
  {
    key: "Total Led Bal MTF+NON MTF+MTC Cash Collateral",
    title: "Total Led Bal MTF+NON MTF+MTC Cash Collateral",
  },
  {
    key: "Total Collateral Value(MTF & NON MTF) (AHC)",
    title: "Total Collateral Value(MTF & NON MTF) (AHC)",
  },
  {
    key: "Total Collateral Value(MTF & NON MTF) (BHC)",
    title: "Total Collateral Value(MTF & NON MTF) (BHC)",
  },
  { key: "Net Diff MTF & NON MTF Led with 100% Stock Value", 
    title: "Net Diff MTF & NON MTF Led with 100% Stock Value" },
];
    ...
    try {
      ...
      allKeys.forEach((accountId) => {
        ...
        finalData.push({
          ...
          "MTF Led Bal (Funded Value)": D,
          "MTF Funded Amount": E,
          "MTF Cash Collateral": F,
          "MTF Share Collateral Full 100% (BHC)": G,
          "MTF Share Collateral after hair-cut (AHC)": H,
          "MTF Funded Stock Mkt Val(AHC)": I,
          "MTF Funded Stock Mkt Val(BHC)": J,
          "MTF Margin": K,
          "Excess / Short Available Limit": L,
          "MTF Loss": M,
          "MTF Funded Stock Funded Value": N,
          "DEF (Normal) Led Balance": O,
          "Total Led Bal MTF+NON MTF+MTC Cash Collateral": P,
          "Total Collateral Value(MTF & NON MTF) (AHC)": Q,
          "Total Collateral Value(MTF & NON MTF) (BHC)": R,
          "Net Diff MTF & NON MTF Led with 100% Stock Value": S,
        });
      });
